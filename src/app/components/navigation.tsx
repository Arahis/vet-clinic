...
const Navigation = () => {
  return (
    <nav className="flex rounded-tr-3xl md:rotate-90 md:origin-top-left md:absolute md:top-0 bg-slate-100 h-28 left-28 justify-center items-center min-w-[770px]">
